...
### Changed
- remove duplicate reload signal polling from AccountHandler

### Fixed
- prevent IMAP state corruption and exit watch loop on reconnect failure


## [2.7.2-pre] - 2026-02-09

### Fixed
- add safe integer conversion for form inputs


## [2.7.1-pre] - 2026-02-09

### Fixed
- add limit to all get_all_uids calls to prevent bandwidth saturation


## [2.7.0-pre] - 2026-02-09

### Added
- implement Outlook-style rule application


## [2.6.0-pre] - 2026-02-09

### Added
- add bandwidth control and rate limiting


## [2.5.1-pre] - 2026-02-09

### Fixed
- improve email logging and account filtering


## [2.5.0-pre] - 2026-02-09

### Added
- implement structured email processing logs


## [2.4.0-pre] - 2026-02-09

### Added
- add time-based log filtering and automatic cleanup
- remove spam auto-categorization feature


## [2.3.1-pre] - 2026-02-09

### Fixed
- read version from file instead of import


## [2.3.0-pre] - 2026-02-09

### Added
- add version display in sidebar
